...
def calculate_bundle_discount(cart: Iterable[Mapping]) -> Tuple[float, str]:
    ...
    # Match the exact required components enforced by app.validate_order_cart().
    pc_core = {"cpu", "motherboard", "ram", "storage", "power_supply", "cabinet", "cooling"}
    mac_core = {"processor", "memory", "storage", "display"}
    iphone_core = {
        "iphone_display", "iphone_battery", "iphone_camera", "iphone_ram",
        "iphone_storage", "iphone_processor", "iphone_connectivity", "iphone_frame", "iphone_color"
    }
    android_core = {
        "android_display", "android_battery", "android_camera", "android_ram",
        "android_storage", "android_processor", "android_connectivity", "android_build", "android_color"
    }
